...
HD_PWD='D:/lany_workspace/Git/vga_con/Vivado_VGA_Controller/Vivado_VGA_Controller.runs/video_BRAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_BRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source video_BRAM.tcl
